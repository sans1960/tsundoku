...
<div class="display-comment" @if($comment->parent_id != null) style="margin-left:40px;" @endif>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('admin.denuncia.store')}}" method="post">
                            ...
                            <input type="hidden" name="objecte_comentari" value="{{$medi->titol}}" id="">
    ...
    <form method="post" action="{{route('reply.medi')}}">
        @csrf
    ...
    @endif
    @include('layouts.medicomment_replies', ['comments' => $comment->replies])
</div>
@endforeach