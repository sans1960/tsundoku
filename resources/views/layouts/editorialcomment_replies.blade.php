...
<div class="display-comment" @if($comment->parent_id != null) style="margin-left:40px;" @endif>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('admin.denuncia.store')}}" method="post">
                            ...
                            <input type="hidden" name="objecte_comentari" value="{{$editorial->editorial_nom}}" id="">
    ...
    @if (Auth::check())
    <a href="" id="reply"></a>
    <form method="post" action="{{route('reply.editorial')}}">
        @csrf
    ...
    @endif
    @include('layouts.editorialcomment_replies', ['comments' => $comment->replies])
</div>
@endforeach