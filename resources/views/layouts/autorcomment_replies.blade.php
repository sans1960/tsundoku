...
<div class="display-comment" @if($comment->parent_id != null) style="margin-left:40px;" @endif>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('admin.denuncia.store')}}" method="post">
                            ...
                            <input type="hidden" name="objecte_comentari" value="{{$autor->autor_nom}}" id="">
    ...
    <form method="post" action="{{route('reply.autor')}}">
        @csrf
    ...
    @endif
    @include('layouts.autorcomment_replies', ['comments' => $comment->replies])
</div>
@endforeach