...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light  shadow-sm ubuntu">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{route('admin.users.index')}}">Usuaris</a></li>
                                <li><a class="dropdown-item" href="{{route('admin.users.bulleti')}}">Bulleti</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{route('admin.banners.index')}}">Banners</a></li>
                                <li><a class="dropdown-item" href="{{route('admin.carrusels.index')}}">Carrusels</a>
                                </li>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="nav-link dropdown-toggle ubuntu" href="#" role="button"
