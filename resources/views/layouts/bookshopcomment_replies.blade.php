...
<div class="display-comment" @if($comment->parent_id != null) style="margin-left:40px;" @endif>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('admin.denuncia.store')}}" method="post">
                            ...
                            <input type="hidden" name="objecte_comentari" value="{{$bookshop->nom}}" id="">
    ...
    @if (Auth::check())
    <a href="" id="reply"></a>
    <form method="post" action="{{route('reply.bookshop')}}">
        @csrf
    ...
    @endif
    @include('layouts.bookshopcomment_replies', ['comments' => $comment->replies])
</div>
@endforeach