                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.books.update',$book) }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="slug" name="slug" value="{{$book->slug}}" readonly>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <input class="form-control" type="text" id="autor_nom" name="autor_nom" value="{{$book->autor_nom}}">
                                </div>
                                <div class="col">
                                    <label for="imatge" class="form-label">Imatge</label>
                                    <input class="form-control" type="text" id="imatge" name="imatge" value="{{$book->imatge}}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <input type="text" class="form-control" id="" placeholder="ISBN"
                                        name="isbn" required value="{{$book->isbn}}">
                                </div>
                                <div class="col">
                                    <input type="text" class="form-control" id="" placeholder="Idioma"
                                        name="idioma" required value="{{$book->idioma}}">
                                </div>
                                <div class="col">
                                    <select class="form-select" aria-label="Default select example" name="user_id">
                                        <option>Escull usuari</option>
                                        @foreach ($users as $user)
                                            <option value="{{ $user->id }}" @if ($book->user_id == $user->id) selected
...
@section('js')
    <script>
        $(document).ready(function() {
            $('#titol').change(function(e) {
                $.get('{{ route('check_slug_book') }}', {
                        'titol': $(this).val()
                    },
                    function(data) {
                        $('#slug').val(data.slug);
