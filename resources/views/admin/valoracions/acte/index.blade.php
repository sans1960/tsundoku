...
<div class="container">
    <div class="col-md-8 mx-auto">
        <div class="card">
            <div class="card-header">{{ __('Tots les valoracions dels actes') }}</div>
    ...
    <div class="row mt-5 mb-5">
        <div class="col-md-12">
            <table class="table mb-5">
                ...
                <tbody>
                    @foreach ($ratingactes as $ratingacte)
                    <tr>

                        <td>{{$ratingacte->user->nickname}}</td>
                        <td>{{$ratingacte->acte->titol}}</td>
        ...
        {!! $ratingactes->withQueryString()->links('pagination::bootstrap-5') !!}
    </div>
