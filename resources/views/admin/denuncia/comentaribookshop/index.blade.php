            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$denuncia->comentbookshop->user->nickname}}</td>
                        <td>{{\Carbon\Carbon::parse($denuncia->created_at)->format('d/m/Y-H:m')}}</td>
                        <td><a href="{{route('denunciacoment.bookshop.show',$denuncia->id)}}"
                                class="btn btn-success btn-sm">
                                <i class="bi bi-eye"></i>
                            </a></td>
                        <td>
                            <form action="{{route('denunciacoment.bookshop.destroy',$denuncia->id)}}" method="post">
                                @csrf
                                @method('delete')
