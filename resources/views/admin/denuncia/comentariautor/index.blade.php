...
<div class="container">
    <div class="col-md-8 mx-auto">
        <div class="card">
            <div class="card-header">{{ __('Totes les denuncies de comentaris Autors') }}</div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$denuncia->comentautor->user->nickname}}</td>
                        <td>{{\Carbon\Carbon::parse($denuncia->created_at)->format('d/m/Y-H:m')}}</td>
                        <td><a href="{{route('denunciacoment.autor.show',$denuncia->id)}}"
                                class="btn btn-success btn-sm">
                                <i class="bi bi-eye"></i>
                            </a></td>
                        <td>
                            <form action="{{route('denunciacoment.autor.destroy',$denuncia->id)}}" method="post">
                                @csrf
                                @method('delete')
