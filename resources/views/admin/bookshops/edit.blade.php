                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.bookshops.update', $bookshop) }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nom" value="{{ $bookshop->nom }}"
                                    name="nom" required>
                            </div>
                            <div class="mb-3">
                                <label for="slug" class="form-label">Slug</label>
                                <input type="text" class="form-control" id="slug" name="slug"
                                    value="{{ $bookshop->nom }}" readonly>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <input type="text" class="form-control" id="latitud"
                                        value="{{ $bookshop->latitud }}" name="latitud" required>
                                </div>
                                <div class="col">
                                    <input type="text" class="form-control" id="longitud"
                                        value="{{ $bookshop->longitud }}" name="longitud" required>
                                </div>
                                <div class="col">
